            ...
            {data && data.blog &&
                <>
                    <div className='border rounded md:w-[70%] w-full p-5'>
                        ...
                        <div className='my-5 prose prose-invert max-w-none text-zinc-100 bg-zinc-900/80 p-2 rounded'>
                            <ReactMarkdown rehypePlugins={[rehypeRaw]}>{decode(data.blog.blogContent) || ''}</ReactMarkdown>
                        </div>
